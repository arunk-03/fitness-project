...
export default function LoginForm() {
    return(
        <>
        <div class="flex flex-col sm:w-1/2 md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#fcfcfc] rounded-2xl shadow-xl my-[60px]">
    <div class="flex flex-col justify-center mx-auto items-center gap-3 pb-4">
        <div>
            <img src={siteConfig.siteIcon} alt="Logo" width="50"/>
        </div>
        
         <h1 class="text-3xl font-bold text-[#4B5563] text-[#4B5563] my-auto">{siteConfig.siteName}</h1>

    </div>
    <div class="text-sm font-light text-[#6B7280] pb-8 mx-auto"></div>
    ...
    <form class="flex flex-col">
        <div class="pb-2">
            ...
            <div class="relative text-gray-400"><span class="absolute inset-y-0 left-0 flex items-center p-1 pl-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg></span> 
                <input type="email" name="email" id="email" class="pl-12 mb-2 bg-gray-50 text-gray-600 border focus:border-transparent border-gray-300 sm:text-sm rounded-lg ring ring-transparent focus:ring-1 focus:outline-none focus:ring-gray-400 block w-full p-2.5 rounded-l-lg py-3 px-4" placeholder="Enter your email" autocomplete="off"/>
            </div>
        </div>
        <div class="pb-6">
        ...
        <button type="submit" class="w-full text-[#FFFFFF] bg-green-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Login</button>
        <div class="text-sm font-light text-[#6B7280] ">Don't have an accout yet? <Link to="/signup" class="font-medium text-green-600 hover:underline">Sign Up</Link>
